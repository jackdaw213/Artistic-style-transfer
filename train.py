...
def main():
    ...
    if args.enable_dali:
        ...
        train_dataset = dataset.StyleDataset(args.train_dir_content, args.train_dir_style)
        val_dataset = dataset.StyleDataset(args.val_dir_content, args.val_dir_style)
